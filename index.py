...
def bd(binaire):
    ...
    for i in binaire:
        if i == '1':
           ...
           print("le rang",n,"est egal à 1 donc on le prend")
        else:
            calculate = calculate + 0
            print("le rang",n,"est egal à 0 donc on le vire")
        n += 1
    print("On prend tous les rang qui son egal à 1")
...
def dh(dec):
    ...
    while itsNull < 1 :
        ...
        if nbBoites == 0:
            ...
            itsNull = 0
    print("Q = 0 donc on arrête")
    print("on recupere tous les Restes que nous avons obtenue")
    print("ce qui nous donne pour l'instant : ", " ".join(numbers))
    print("Puis on inverse ce qui nous donne le résultat final :")
    numbers.reverse()
